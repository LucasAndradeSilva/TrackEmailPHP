...
if( !empty( $_GET['log'] ) == 'true')
{
    ...
    // $graphic_http = 'http://trackermysql/blank.gif';
	// $filesize = filesize( 'C://wamp64/www/EmailTracker_MySql/blank.gif' );
	$graphic_http = 'http://trackermysql/back2.jpg';
    $filesize = filesize( 'C://wamp64/www/EmailTracker_MySql/back2.jpg' );
    header( 'Pragma: public' );
    header( 'Expires: 0' );
    header( 'Cache-Control: must-revalidate, post-check=0, pre-check=0' );
    header( 'Cache-Control: private',false );
    header( 'Content-Disposition: attachment; filename="back2.jpg"' );
